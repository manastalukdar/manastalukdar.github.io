...
|----------|----------|------------|--------|
| Linux | GitHub CI | Build | ![build](https://github.com/manastalukdar/manastalukdar.github.io/workflows/build/badge.svg) |
| Linux | Circle CI | Build, Deploy to master | [![CircleCI](https://circleci.com/gh/manastalukdar/manastalukdar.github.io/tree/source.svg?style=svg)](https://circleci.com/gh/manastalukdar/manastalukdar.github.io/tree/source) |
