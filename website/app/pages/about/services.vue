...
const currentPage =
  navigationStore.about.aboutItems[6].text +
  ' | ' +
  navigationStore.about.aboutText;
const currentHref = navigationStore.about.aboutItems[6].href;
const servicesText = navigationStore.about.aboutItems[6].text;
