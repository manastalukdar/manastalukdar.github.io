...
const currentHref = navigationStore.about.aboutItems[0].professionalItems[3].engagementsItems[1].href;
const fellowshipsText = navigationStore.about.aboutItems[0].professionalItems[3].engagementsItems[1].text;
