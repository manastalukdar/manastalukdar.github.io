    ...
    <v-col cols="12">
      ...
      >
        <v-row class="text-h5 px-3 py-3 page-header justify-center">
          <span>Professional Memberships and Affiliations</span>
        </v-row>
        <p />
...
const currentHref = navigationStore.about.aboutItems[0].professionalItems[3].engagementsItems[0].href;
const membershipsAffiliationsText = navigationStore.about.aboutItems[0].professionalItems[3].engagementsItems[0].text;
...
const description = 'Professional memberships and organizational affiliations.';
...
const breadcrumbsData = [
  ...
  {
    title: membershipsAffiliationsText,
    disabled: false,
    href: currentHref,
    exact: true,
  }
